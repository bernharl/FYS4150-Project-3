...
version (Homebrew GCC $9.2.0\_1$) $9.2.0$.\\\\ When calculating the integral,
...
\begin{figure}[h]
	...
	\caption{Figure showing the relative error for the brute force gaussian quadrature and the improved gaussian quadrature methods described in subsection \ref{subsec:brute_force_gauss} and \ref{subsec:improved_gauss} respectively. A line is drawn when the relative error is $10^-2$ to illustrate when the integral reaches three digit precision.}
...
\begin{figure}[h]
	...
	\caption{Figure showing the relative error for the brute force and the improved Monte Carlo methods described in subsection \ref{subsec:brute_force_monte_carlo} and \ref{subsec:improved_monte_carlo} respectively.}
	\label{fig:rellerrcarlo}
\end{figure}

\begin{figure}[h]
	\includegraphics[scale=0.55]{{Figures/variance_monte_carlo}.pdf}
	\caption{Figure showing the variance for the brute force and the improved Monte Carlo methods as described in subsection \ref{subsec:brute_force_monte_carlo} and \ref{subsec:improved_monte_carlo} respectively.}
...
\begin{figure}[h]
	...
	\caption{Figure showing the CPU time the brute force and the improved Monte Carlo methods described in subsection \ref{subsec:brute_force_monte_carlo} and \ref{subsec:improved_monte_carlo} respectively. For both methods the CPU time was compared both unparallelized and parallelized with two threads.}
	\label{fig:CPUcarlo}
\end{figure}
